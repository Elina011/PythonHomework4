...
list1 = list(randint(1, 5) for i in range(int(input('Введите количество кустов: '))))
print(list1)
bushnumber = int(input('Введите номер куста: '))
res = 0
if bushnumber == 1:
    res = list1[0] + list1[1] + list1[-1]
elif bushnumber == len(list1):
    res = list1[-2] + list1[-1] + list1[0]
else:
    res = list1[bushnumber-1] + list1[bushnumber-2] + list1[bushnumber]
print(res, 'ягод')